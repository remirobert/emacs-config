...
(custom-set-faces
 '(default ((t (:overline nil :inherit nil :stipple nil
                :foreground "#0" :inverse-video nil :box nil
 ...
 '(font-lock-string-face ((t (:foreground "red" :weight bold :slant italic))))
 ...
 '(menu ((t (:background "black" :foreground "black"))))
 ...
 '(mouse ((t (:background "black" :foreground "black"))))
